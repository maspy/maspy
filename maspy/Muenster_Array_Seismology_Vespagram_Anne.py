...
def show_distance_plot(stream, event, inventory, starttime, endtime,
    ...
    if plot_travel_times:
        ...
        for i in np.linspace(dist_min, dist_max, 100):
            tts = getTravelTimes(i, event_depth_in_km, "ak135", phase_list=['P', 'PcP', 'PKiKP', 'Pdiff','PP','P^410P','P^660P', 'pP', 'sP'])
            #tts = getTravelTimes(i, event_depth_in_km, "ak135", phase_list=['Pdiff','PP'])
            for phase in tts:
